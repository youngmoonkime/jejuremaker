...
const Trending: React.FC<TrendingProps> = ({ onNavigate, onProjectSelect, isDarkMode, toggleDarkMode, language, toggleLanguage, user, onLoginClick, onLogout, projects, onLikeToggle, likedProjects }) => {
