...
const ProjectDetail: React.FC<ProjectDetailProps> = ({ onBack, onOpenWorkspace, isDarkMode, toggleDarkMode, language, toggleLanguage, project, user, onLoginClick, onNavigate }) => {
  ...
  const handleDownload = () => {
    if (user) {
        // User is logged in, can download
        alert('Download started...');
    } else {
        // User not logged in, show auth modal and stay on detail page
        onLoginClick('detail');
    }
  };
