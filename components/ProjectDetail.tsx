...
const ProjectDetail: React.FC<ProjectDetailProps> = ({ onBack, onOpenWorkspace, isDarkMode, toggleDarkMode, language, toggleLanguage, project, user, onLoginClick, onNavigate, onLikeToggle, onViewIncrement, likedProjects }) => {
